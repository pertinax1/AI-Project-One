...
│   main.py
│   ML_Churn_2.ipynb
│   Phase One Presentation.pdf
│   Phase One Proposal.pdf
│   Proposal.docx
│   Readme.md
│   Steps to create bins.docx
│
├───output -- These files are outputs, some of which were consumed in downstream 
|             processing
│   │   account_df.csv
│   │   account_df.xlsx
│   │   columns_to_exclude.csv
│   │   column_names_to_bin.csv
│   │   interactive_plot.html
│   │
│   ├───churn_ratio_dfs  -- Generated by main.py. Used to make feature plots
...
│   │       trigger_quality.csv
│   │
│   └───images  -- these image files were the plots generated (churn for each 
|                   feature)
│       ├───bar_and_line
...
│       │       churn_vs_avg_monthly_bill_bin.png
│       │       churn_vs_contract_duration.png
│       │       churn_vs_gender.png
│       │       churn_vs_internet_min_bin.png
│       │       churn_vs_internet_services.png
│       │       churn_vs_number_customer_service_calls_bin.png
│       │       churn_vs_payment_method.png
│       │       churn_vs_phone_min_bin.png
│       │       churn_vs_phone_services.png
│       │       churn_vs_tenure_bin.png
│       │       churn_vs_treatment.png
│       │
│       └───line_only
│               ai_ambb.png
...
│               ai_tpb.png
│
├───Resources  -- The accounts_predict_data is our raw data that we performed the 
                  analysis on.
│       account_predict_data.csv
│
└───__pycache__  -- internal file
